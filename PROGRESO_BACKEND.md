...
El próximo foco lógico es completar vistas de propietario pendientes (`MisGastos`, `MisExpensas` o `MisPagos`) o avanzar sobre autenticación/testing, dejando autorización real completa para una etapa posterior.
