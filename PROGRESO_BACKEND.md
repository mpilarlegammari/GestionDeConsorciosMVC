...
- Hay backend real para Consorcios + Unidades Funcionales, y backend parcial para gastos, expensas y pagos.
...
El próximo foco lógico es reforzar `Gastos`, porque es Prioridad 2 y ya tiene servicios/ViewModel creados pero todavía faltan filtros completos, vistas de edición/eliminación y autorización por rol.
