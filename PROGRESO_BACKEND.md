...
El próximo foco lógico es avanzar a `Reclamos` o completar vistas de propietario pendientes (`MisGastos`, `MisExpensas` o `MisPagos`), dejando autorización real para una etapa posterior.
