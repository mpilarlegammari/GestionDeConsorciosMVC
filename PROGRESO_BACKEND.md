...
El próximo foco lógico es reforzar `MisPagos` con ViewModel/filtros o avanzar sobre seed/testing, dejando autorización real completa para una etapa posterior.
